...
class ReviewController extends AbstractRestController implements ClassResourceInterface, SecuredControllerInterface
{
    ...
    protected function load(int $id, Request $request): ?Review
    {
        return $this->reviewRepository->findById($id, (string)$this->getLocale($request));
    }
    ...
    {
        $platformId = (isset($data['platform']['id'])) ? $data['platform']['id'] : $data['platform'];
        ...
        $entity->setPlatform($this->categoryManager->findById($platformId));
    ...
    public function postTriggerAction(int $id, Request $request): Response
    {
        ...
        try{
            switch($action){
                case 'enable':
                    $item = $this->entityManager->getReference(Review::class, $id);
