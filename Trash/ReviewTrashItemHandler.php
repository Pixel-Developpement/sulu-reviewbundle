...
class ReviewTrashItemHandler implements StoreTrashItemHandlerInterface, RestoreTrashItemHandlerInterface, RestoreConfigurationProviderInterface
{
    ...
    public function store(object $resource, array $options = []): TrashItemInterface
    {
        ...
        $data = [
            ...
            "clientImage" => $clientImage ? $clientImage->getId() : null,
    ...
    public function restore(TrashItemInterface $trashItem, array $restoreFormData = []): object
    {
        ...
        $review->setPlatform($this->entityManager->find(CategoryInterface::class, $data['platformId']));
        $review->setCategory($this->entityManager->find(CategoryInterface::class, $data['categoryId']));
    ...
    {
        return new RestoreConfiguration(null, ReviewAdmin::REVIEW_EDIT_FORM_VIEW, ['id' => 'id']);
    }
}
